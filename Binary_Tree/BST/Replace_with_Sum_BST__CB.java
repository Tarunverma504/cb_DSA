...
*/
import java.util.*;
public class Replace_with_Sum_BST__CB {
    private class Node {
        int data;
        Node left;
        Node right;
    ...
    public Replace_with_Sum_BST__CB() {
        this.root = null;
        this.size = 0;
    }
	...
	public static void replaceWLS(Node root){
		if(root==null)
			return;
	...
	public static void Replace_with_Sum_BST__CB(String[] args) {
        Replace_with_Sum_BST__CB b1= new Replace_with_Sum_BST__CB();
